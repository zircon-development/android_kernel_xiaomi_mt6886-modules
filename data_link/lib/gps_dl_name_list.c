...
const char *const gps_dl_link_event_name_list[GPS_DL_LINK_EVT_NUM + 1] = {
	...
	[GPS_DL_EVT_LINK_ENTER_DSLEEP]    = "LINK_ENTER_DSLEEP",
	[GPS_DL_EVT_LINK_EXIT_DSLEEP]     = "LINK_EXIT_DSLEEP",
	[GPS_DL_EVT_LINK_ENTER_DSTOP]     = "LINK_ENTER_DSTOP",
	[GPS_DL_EVT_LINK_EXIT_DSTOP]      = "LINK_EXIT_DSTOP",
